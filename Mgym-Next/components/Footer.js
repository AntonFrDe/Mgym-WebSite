  ...
  return (
    <footer>
      <div className="footer-inner">
        ...
        <div>
          <div className="footer-brand">
            ...
            <div>
              ...
              <div className="footer-brand-sub">Bien-être &amp; Santé</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="footer-tagline">
            &ldquo;Bougeons ensemble&rdquo;
            <small>Mirepoix-sur-Tarn · depuis les années 80</small>
          </div>
        </div>
        ...
        <div className="footer-right">
          ...
          <div className="footer-socials">
            ...
            <a href="mailto:gym.mirepoix@gmail.com" aria-label="Email M'GYM">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
                <polyline points="22,6 12,13 2,6"/>
              </svg>
            </a>
            <a href="tel:0609316145" aria-label="Téléphone M'GYM">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      ...
      <div className="footer-bottom">
        © 2025 M&apos;GYM Association · Route de Layrac-sur-Tarn, 31340 Mirepoix-sur-Tarn
        · 06 09 31 61 45 · gym.mirepoix@gmail.com
      </div>
    </footer>
  )
}
